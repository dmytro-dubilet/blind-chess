...
This source snapshot corresponds to version 1.1 (51). It is not a statement that Apple has approved or published the app. Private development logs and regression recordings are not included.
