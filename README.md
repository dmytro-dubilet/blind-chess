...
This source snapshot corresponds to the release candidate 1.0 (47). It is not a statement that Apple has approved or published the app. Private development logs and regression recordings are not included.
